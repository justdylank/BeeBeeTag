...
def Shot_Hasen():
    ...
    def upon_IMMEDIATE():
        Unknown4006(2)
        Unknown2019(-998)
        Unknown48(25, 2, 12, 2, 2, 12)
        Unknown48(25, 2, 13, 2, 2, 13)
        Unknown1019(80)
        YAccel(80)
...
@Subroutine
def UltimateShotChargeEX_Param():  
    Unknown2019(-999)
    Unknown2053(1)
    Unknown23013(1)
    Unknown23022(1)
...
@State
def ShotUltimateChargeA():

    def upon_IMMEDIATE():
        Unknown2010()
        callSubroutine('UltimateShotCharge_Param')
        callSubroutine('ShotChargeColor')
        physicsXImpulse(6500)
...
def AstralLastBlade():
    ...
    Unknown1096(8000)
    Unknown21015('AstralExeCamera', 5001, 0)
