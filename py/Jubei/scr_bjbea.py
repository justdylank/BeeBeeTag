...
def jbef_Air5DHit():
    ...
    sprite('null', 20)
    Unknown4048(80000)
    Unknown4045('jbef_driveslash_sumi', -1)
    sprite('null', 58)
    Unknown1099(10)
    Unknown4003('jbef_DriveSlashEnd', '')
...
def DriveSpeed():
    ...
    Unknown48(3, 2, 12, 25, 2, 12)
    Unknown48(3, 2, 13, 25, 2, 13)
...
def MAKERMoveEffSumi():
    ...
    Unknown4061(2)
    Unknown4045('jbef_drive_sumi', 0)
    Unknown4045('jbef_drive_sumi', 1)
    Unknown4045('jbef_drive_sumi', 2)
...
def Shiranui_Hagane_236Aobj():
    ...
    GFX_0('test1', 0)
    sprite('Drive_TameMoveAtk', 5)
    Unknown48(25, 2, 56, 6, 2, 22)
    if SLOT_38:
        Unknown47('0100000002000000160000000200000038000000020000000c000000')
    else:
        Unknown47('0100000002000000380000000200000016000000020000000c000000')
    Unknown48(25, 2, 56, 6, 2, 23)
    Unknown47('0100000002000000380000000200000017000000020000000d000000')
    callSubroutine('DriveSpeed')
    RefreshMultihit()
    callSubroutine('DriveAtk')
    ...
    GFX_0('test2', 0)
    sprite('Drive_TameMoveAtk', 5)
    Unknown48(25, 2, 56, 7, 2, 22)
    if SLOT_38:
        Unknown47('0100000002000000160000000200000038000000020000000c000000')
    else:
        Unknown47('0100000002000000380000000200000016000000020000000c000000')
    Unknown48(25, 2, 56, 7, 2, 23)
    Unknown47('0100000002000000380000000200000017000000020000000d000000')
    callSubroutine('DriveSpeed')
    RefreshMultihit()
    callSubroutine('DriveAtk')
    ...
    GFX_0('test3', 0)
    sprite('Drive_TameMoveAtk', 5)
    Unknown48(25, 2, 56, 8, 2, 22)
    if SLOT_38:
        Unknown47('0100000002000000160000000200000038000000020000000c000000')
    else:
        Unknown47('0100000002000000380000000200000016000000020000000c000000')
    Unknown48(25, 2, 56, 8, 2, 23)
    Unknown47('0100000002000000380000000200000017000000020000000d000000')
    callSubroutine('DriveSpeed')
    RefreshMultihit()
...
def jbef407_NekodamaRady():
    ...
    Unknown4047(2, 2, 2)
    Unknown4045('jbef_407_nokosi', 0)
    Unknown4047(2, 2, 2)
    Unknown4045('jbef_407_nokosi', 1)
    Unknown4047(2, 2, 2)
    Unknown4045('jbef_407_nokosi', 2)
    Unknown4047(2, 2, 2)
    Unknown4045('jbef_407_nokosi', 3)
...
def jb430_slashMatome():
    ...
    sprite('null', 58)
    Unknown4010(0)
    Unknown21015('jb430_slashAdd', 4301, 0)
...
def jb431OD_SlashEffMatome():
    ...
    label(0)
    sprite('null', 4)
    Unknown21015('jb431OD_SlashEff00', 4311, 0)
    sprite('null', 4)
    Unknown21015('jb431OD_SlashEff01', 4312, 0)
    sprite('null', 1)
    Unknown21015('jb431OD_SlashEff02', 4313, 0)
...
def jb432_eyerayEff():
    ...
    Unknown4045('jbef_432buff_hatudo', 100)
...
def jb440_slash00():
    ...
    Unknown4061(2)
    Unknown4047(1, 1, 1)
    Unknown4045('jbef_440suminokosi', 100)
    sprite('null', 5)
    Unknown21010(0)
    sprite('null', 57)
...
def jb440_AddAtk():
    ...
    Unknown4061(2)
    Unknown4047(1, 1, 1)
    Unknown4045('jbef_440suminokosi2', 100)
    Unknown21004(1)
