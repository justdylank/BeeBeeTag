...
def PNA_ReceptionSignal():
    ...
    def upon_43():
        ...
        if (SLOT_48 == 405):
            Unknown23185('BlightA', 100)
        if (SLOT_48 == 406):
            Unknown23185('BlightB', 100)    
        if (SLOT_48 == 407):
            Unknown23185('BlightEX', 100)
        if (SLOT_48 == 408):
            Unknown23185('Blight', 100)
        if (SLOT_48 == 408):
...
def PNA_Persona5B():
    ...
    def upon_IMMEDIATE():
        Unknown23023()
        Unknown23184(3, 100, 100000, 100000, 0, 2000000, -300000, 500000)
...
def Blight():
    ...
    def upon_IMMEDIATE():
        Unknown23023()
        Unknown23184(3, 100, 100000, 70000, 0, 2000000, -300000, 500000)
        callSubroutine('PNA_SPAttackInit')
        AttackLevel_(4)
        Damage(600)
        Unknown11075(300, 150)
        AttackP1(90)
        Unknown11092(1)
        Hitstop(1)
        PushbackX(12000)
...
def BlightB():
    ...
    def upon_IMMEDIATE():
        Unknown23023()
        Unknown23184(3, 100, 100000, 120000, 0, 2000000, -300000, 500000)
        callSubroutine('PNA_SPAttackInit')
        AttackLevel_(4)
        Damage(350)
        Unknown11075(300, 150)
...
def BlightEX():
    ...
    def upon_IMMEDIATE():
        Unknown23023()
        Unknown23184(3, 100, 100000, 150000, 0, 2000000, -300000, 500000)
        callSubroutine('PNA_SPAttackInit')
        AttackLevel_(4)
        Damage(350)
        AttackP1(90)
...
def PartnerAssistAtk_D():
    ...
    def upon_IMMEDIATE():
        Unknown23023()
        Unknown23184(3, 100, 0, 100000, -10000000, 10000000, -10000000, 10000000)
        callSubroutine('PNA_SPAttackInit')
        AttackLevel_(4)
        Damage(1200)
        AttackP1(70)
...
def TrapMatome():
        ...
        if SLOT_8:
            ...
            def upon_3():
                ...
                if (SLOT_165 < 210000):
                    sendToLabel(14)
                    clearUponHandler(3)
                if (not Unknown48(25, 2, 0, 2, 2, 158)):
    ...
    if (SLOT_95 == 0):
        ...
        Unknown4003('naef_trapicon_ground.DIG', 'naef_trapicon_ground_0000.mmot')
        Unknown4015()
...
def Hamaon():
    ...
    def upon_IMMEDIATE():
        ...
        def upon_78():
            SLOT_55 = 1
            Unknown48(25, 2, 51, 22, 2, 95)
            if (SLOT_51 == 0):
                Unknown48(25, 2, 52, 3, 2, 63)
                if (SLOT_52 == 2):
                    SLOT_53 = 1
            elif (SLOT_51 == 1):
                Unknown48(25, 2, 52, 3, 2, 64)
                if (SLOT_52 == 2):
                    SLOT_53 = 1
            elif (SLOT_51 == 2):
                Unknown48(25, 2, 52, 3, 2, 65)
                if (SLOT_52 == 2):
                    SLOT_53 = 1
            elif (SLOT_51 == 3):
                Unknown48(25, 2, 52, 3, 2, 66)
                if (SLOT_52 == 2):
                    SLOT_53 = 1
            if SLOT_53:
                Unknown23083(1)
...
def Mudoon():
    ...
    def upon_IMMEDIATE():
        ...
        def upon_78():
            Unknown48(25, 2, 51, 3, 2, 6)
            if SLOT_51:
                Unknown2037(1)
            Unknown48(25, 2, 52, 22, 2, 170)
            if SLOT_52:
                Unknown2037(0)
            if SLOT_2:
...
def Ichigeki_Marker():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown11064(1)
        Unknown11032(140000, -140000, -1, -1)
        Unknown11050(5, '')
