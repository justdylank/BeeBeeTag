...
def PKA_ReceptionSignal():
    ...
    def upon_43():
        if (SLOT_48 == 2040):
            Unknown23185('PKA_Persona5B', 50)
        if (SLOT_48 == 2041):
            Unknown23185('PKA_Persona5B_Normal', 50)
        if (SLOT_48 == 2042):
            Unknown23185('PKA_Persona5B_Hold', 50)
        if (SLOT_48 == 2043):
            Unknown23185('PKA_Persona5B_Hold_Just', 50)
        if (SLOT_48 == 2044):
            Unknown23185('PKA_Persona5B_CA', 50)
        if (SLOT_48 == 2050):
            Unknown23185('PKA_Persona5B2nd', 50)
        if (SLOT_48 == 2051):
            Unknown23185('PKA_Persona5B2nd_Hold', 50)
        if (SLOT_48 == 2052):
            Unknown23185('PKA_Persona5B2nd_Hold_Just', 50)
        if (SLOT_48 == 2053):
            Unknown23185('PKA_Persona5B2nd_CA', 50)
        if (SLOT_48 == 4080):
            Unknown23185('PKA_Persona4Assist', 50)
        if (SLOT_48 == 2540):
            Unknown23185('PKA_PersonaA_Finish', 50)
        if (SLOT_48 == 2530):
            Unknown23185('PKA_PersonaAir5C', 50)
        if (SLOT_48 == 2531):
            Unknown23185('PKA_PersonaAir5C_ATK', 50)
        if (SLOT_48 == 4000):
            Unknown23185('PKA_PersonaInvincibleAttack', 50)
        if (SLOT_48 == 4020):
            Unknown23185('PKA_PersonaKushizashiA', 50)
        if (SLOT_48 == 4040):
            Unknown23185('PKA_PersonaTsukameB', 50)
        if (SLOT_48 == 4021):
            Unknown23185('PKA_PersonaKushizashiEX', 50)
        if (SLOT_48 == 4300):
            Unknown23185('PKA_PersonaKenkaOD', 100)
        if (SLOT_48 == 4301):
            Unknown23185('PKA_PersonaKenkaOD_DUO', 100)
        if (SLOT_48 == 4310):
            Unknown23185('PKA_PersonaKurokoge', 100)
        if (SLOT_48 == 4500):
            Unknown23185('PKA_PersonaIchigeki', 300)
        if (SLOT_48 == 4501):
            Unknown23185('PKA_PrimalForceA', 50)
        if (SLOT_48 == 4502):
            Unknown23185('PKA_PrimalForceB', 50)
        if (SLOT_48 == 4503):
            Unknown23185('PKA_PrimalForceEX', 50)
        if (SLOT_48 == 4504):
            Unknown23185('PKA_LightningA', 50)
        if (SLOT_48 == 4505):
            Unknown23185('PKA_LightningB', 50)    
        if (SLOT_48 == 4506):
            Unknown23185('PKA_LightningEX', 50)
        if (SLOT_48 == 4507):
            Unknown23185('PKA_LightningAirA', 50)
        if (SLOT_48 == 4508):
            Unknown23185('PKA_LightningAirB', 50)
        if (SLOT_48 == 4509):
            Unknown23185('PKA_LightningAirEX', 50)
        if (SLOT_48 == 9999):
...
def PKA_Persona5B():
    ...
    def upon_IMMEDIATE():
        Unknown23023()
        Unknown23184(3, 100, -100000, 0, -1000000, 2000000, 0, 0)
        callSubroutine('PKA_AttackInit')
...
def PKA_Persona5B2nd():
    ...
    def upon_IMMEDIATE():
        Unknown23023()
        Unknown23184(3, 100, -50000, 0, -1000000, 2000000, 0, 0)
        callSubroutine('PKA_AttackInit')
...
def PKA_LightningA():
    ...
    sprite('ta205_06', 1)
    sprite('ta205_05', 2)
    GFX_0('ta_Air5DThunderTuika', 100)
    GFX_1('taef_thunderbolt', 0)
    GFX_1('taef_thunderbolt', 1)
    sprite('ta205_06', 1)
    sprite('ta205_07', 2)
...
def PKA_PersonaInvincibleAttack():
    ...
    def upon_IMMEDIATE():
        Unknown23023()
        Unknown23184(3, 100, -192000, 0, 0, 0, 0, 0)
...
def PKA_PersonaKushizashiA():
    ...
    def upon_IMMEDIATE():
        Unknown23023()
        Unknown23184(22, 100, -100000, 650000, 0, 0, 0, 0)
        Unknown17012(2, 0, 0)
        callSubroutine('PKA_SPAttackInit')
        AttackLevel_(4)
        Damage(2500)
...
def PKA_PersonaTsukameB():
    ...
    def upon_IMMEDIATE():
        Unknown23023()
        Unknown23184(3, 100, 0, 0, 0, 2000000, -1000000, 400000)
        callSubroutine('PKA_SPAttackInit')
        HitAirUnblockable(4)
        Damage(0)
        AttackP1(80)
        ...
        Unknown11046(1)
        Unknown11044(1)
        Unknown11032(150000, -50000, 500000, -150000)
        Unknown11034(1)
        ProjectileDurabilityLvl(0)
        Unknown11082(1)
        Unknown11068(1)
...
def PKA_PersonaKurokoge():
    ...
    def upon_IMMEDIATE():
        Unknown23023()
        Unknown23184(3, 100, -500000, 0, 0, 0, 0, 0)
...
def PKA_PersonaKurokoge_Exe():
    ...
    sprite('ta432_03', 2)
    Unknown1084(1)
    Unknown21015('Kurokoge_Exe', 4314, 0)
    Unknown20000(1)
    SFX_3('down_steal_m')
    Unknown5000(10, 0)
    Unknown5001(0, 1, 1, 0, 0)
    ...
    SFX_3('electric_m')
    SFX_3('quake_l')
    Unknown21015('Kurokoge_Exe', 4313, 0)
    sprite('ta432_06', 8)
    SFX_3('electric_m')
    ScreenShake(0, 5000)
    sprite('ta432_06', 8)
    ...
    Unknown21015('Kurokoge_Exe', 4315, 0)
    sprite('ta432_05', 40)
    sprite('ta432_05', 30)
    sprite('keep', 32767)
    enterState('PersonaDeleteAndIdling')
...
def ka_isuyoko_assist():
    ...
    AirPushbackY(-12000)
    YImpluseBeforeWallbounce(2000)
    Unknown11032(1000000, -100000, -1, -1)
    loopRest()
    ExitState()
    label(44)
    sprite('null', 1)
    ...
    def upon_IMMEDIATE():
        ...
        def upon_43():
            ...
            if (SLOT_48 == 4304):
                sendToLabel(66)
            if (SLOT_48 == 4307):
                Unknown30070('ka_isuokiseme_DSD')
                sendToLabel(77)
            if (SLOT_48 == 4305):
                Unknown30048(1)
                Damage(100)
...
def PKA_PersonaIchigeki():
    ...
    def upon_IMMEDIATE():
        Unknown23023()
        Unknown23184(22, 100, 0, 0, 0, 0, 0, 0)
        callSubroutine('PKA_DDAttackInit')
        Unknown2012()
        Damage(0)
        AirPushbackX(0)
    ...
    Unknown26('SCEF_FadeBlack12In')
    Unknown21012('kaef_ichigeki_BG00', 36)
...
def ta450_charge():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown4009(2)
        Unknown4010(2)
        Unknown4003('kaef_450_charge_00', '')
        Unknown4015()
        Unknown3033()
        Unknown4061(3)
...
def ta450_Throw():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown4010(2)
        Unknown3032()
        Unknown4003('kaef_450_thunder_02.DIG', '')
        Unknown4015()
        Unknown1000(100000)
    sprite('null', 7)
...
def ta450_RandThrow00():
    ...
    def upon_IMMEDIATE():
        Unknown4007(2)
    sprite('null', 5)
    Unknown4003('kaef_450_thunder_01.DIG', '')
    Unknown4015()
    Unknown3032()
    Unknown1062(-500, 500)
...
def ta450_Thunder():
    ...
    SFX_3('thunder_s')
    sprite('null', 5)
    Unknown4003('kaef_450_thunder_00.DIG', '')
    GFX_0('ta450_RandThrowMato', 100)
    Unknown4015()
...
def ta450_Light():
    ...
    def upon_IMMEDIATE():
        Unknown4007(2)
        Unknown4003('kaef_450_light_00.DIG', '')
        Unknown4015()
        Unknown3032()
        Unknown3001(0)
        Unknown1000(100000)
...
def ta450_ThunderShock():
    ...
    def upon_IMMEDIATE():
        Unknown4007(2)
        Unknown4003('kaef_450_flash.DIG', '')
        Unknown4015()
        Unknown3032()
    sprite('null', 10)
    Unknown1099(100)
...
def ta450_ThunderShock2():
    ...
    def upon_IMMEDIATE():
        Unknown4007(2)
        Unknown4003('kaef_450_flash2.DIG', '')
        Unknown4015()
        Unknown3032()
    sprite('null', 3)
    sprite('null', 10)
...
def ka450_PunchAura():
    ...
    def upon_IMMEDIATE():
        Unknown4007(2)
        Unknown4003('kaef_450_punchaura_00.DIG', '')
        Unknown4015()
        Unknown3032()
        Unknown3001(0)
        Unknown1000(180000)
...
def cutin():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown23015(5)
        Unknown3060(0, 'vr_cutintest1')
        Unknown3063(0, -505000)
        Unknown3062(0, 0)
        Unknown3060(1, 'vr_cutintest2')
